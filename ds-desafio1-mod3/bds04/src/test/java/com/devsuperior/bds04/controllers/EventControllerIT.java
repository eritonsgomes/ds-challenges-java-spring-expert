...
public class EventControllerIT {
	...
	public void insertShouldReturn401WhenInvalidToken() throws Exception {
		...
		EventRequestDTO dto = new EventRequestDTO(null, "Expo XP", LocalDate.of(2021, 5, 18), "https://expoxp.com.br", 1L);
	...
	public void insertShouldInsertResourceWhenClientLoggedAndCorrectData() throws Exception {
		...
		EventRequestDTO dto = new EventRequestDTO(null, "Expo XP", nextMonth, "https://expoxp.com.br", 1L);
		String jsonBody = objectMapper.writeValueAsString(dto);
	...
	public void insertShouldReturn422WhenAdminLoggedAndBlankName() throws Exception {
		...
		EventRequestDTO dto = new EventRequestDTO(null, "      ", nextMonth, "https://expoxp.com.br", 1L);
		String jsonBody = objectMapper.writeValueAsString(dto);
	...
	public void insertShouldReturn422WhenAdminLoggedAndPastDate() throws Exception {
		...
		EventRequestDTO dto = new EventRequestDTO(null, "Expo XP", pastMonth, "https://expoxp.com.br", 1L);
		String jsonBody = objectMapper.writeValueAsString(dto);
	...
	public void insertShouldReturn422WhenAdminLoggedAndNullCity() throws Exception {
		...
		EventRequestDTO dto = new EventRequestDTO(null, "Expo XP", nextMonth, "https://expoxp.com.br", null);
		String jsonBody = objectMapper.writeValueAsString(dto);
