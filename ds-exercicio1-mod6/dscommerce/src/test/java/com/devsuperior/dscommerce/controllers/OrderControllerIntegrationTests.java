...
import com.devsuperior.dscommerce.utils.OAuth2Util;
...
public class OrderControllerIntegrationTests {
	...
	void setUp() throws Exception {
		...
		clientToken = authUtil.obtainAccessToken(mockMvc, clientUsername, clientPassword);
		adminToken = authUtil.obtainAccessToken(mockMvc, adminUsername, adminPassword);
		adminOnlyToken = authUtil.obtainAccessToken(mockMvc, adminOnlyUsername, adminOnlyPassword);
	...
	public void findByIdShouldReturnOrderDTOWhenIdExistsAndClientLogged() throws Exception {
		...
		result.andExpect(jsonPath("$.moment").value("2022-07-29T15:50:00Z"));
